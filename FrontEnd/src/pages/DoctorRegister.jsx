...
const DoctorRegister = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-white w-full flex justify-center items-center p-2 overflow-hidden">
      <div className="max-h-800px w-full max-w-5xl bg-white/90 rounded-2xl p-3 flex flex-col shadow-2xl backdrop-blur-sm border border-teal-100 overflow-y-auto ">
