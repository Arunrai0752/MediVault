...
const Profile = () => {
  ...
  return (
    <main className='p-4 md:p-6 bg-gradient-to-br from-blue-50 to-cyan-50 min-h-screen'>
        ...
        <div className='bg-white rounded-xl shadow-md p-6 mb-6 border border-blue-100'>
          <div className='flex flex-col md:flex-row items-center'>
            ...
            <div className='flex-1 text-center md:text-left'>
              <h1 className='text-2xl md:text-3xl font-bold text-blue-900'>Dr. {userData.fullName}</h1>
              <p className='text-blue-600 font-medium'>{userData.specialization}</p>
              <div className='flex items-center justify-center md:justify-start mt-2'>
               
              </div>
              <div className='mt-3 flex flex-wrap items-center justify-center md:justify-start gap-2'>
                <span className='flex items-center text-sm text-gray-600'><FaMapMarkerAlt className='mr-1 text-blue-500' /> {userData.hospital || 'Medical Center'}</span>
                <span className='flex items-center text-sm text-gray-600'><FaClock className='mr-1 text-blue-500' /> {userData.consultationHours || '9:00 AM - 5:00 PM'}</span>
              </div>
            </div>
          ...
          <div className='flex overflow-x-auto'>
            {['overview', 'professional', 'availability', 'services'].map(tab => (
              <button
                ...
                className={`px-6 py-4 font-medium flex items-center transition-colors ${activeTab === tab ? 'text-blue-600 border-b-2 border-blue-600 bg-blue-50' : 'text-gray-600 hover:text-blue-500'}`}
              >
          ...
          {activeTab === 'professional' && (
            <div className='p-6'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <div className='bg-blue-50 p-4 rounded-lg'>
                  <label className='block text-blue-600 mb-2'>Years of Experience</label>
                ...
                <div className='bg-blue-50 p-4 rounded-lg'>
                  <label className='block text-blue-600 mb-2'>Department</label>
