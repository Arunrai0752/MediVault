...
const About = () => {
  return (
    <main className='w-full min-h-screen bg-gradient-to-br from-green-50 to-blue-50 pt-16 pb-20 px-4'>
     
      <div className='flex justify-center mb-12'>
        <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-gray-700 pb-4 border-b-4 border-blue-500'>
          About <span className='text-blue-600'>MediVault</span>
        </h1>
      </div>

      <div className='w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4'>
       
        <div className='bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-blue-100'>
        ...
        <div className='bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-blue-100'>
          <div className='h-60 bg-purple-100 flex items-center justify-center'>
